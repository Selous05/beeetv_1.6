 ...
 */
package com.beeecorptv.ui.player.utilities;
...
public class EventLogger implements AnalyticsListener,
    ...
    @Override
    public void onPlayerError(@NotNull EventTime eventTime, ExoPlaybackException e) {
        Timber.e(e, "playerFailed [" + getSessionTimeString() + "]");
    }

    @Override
    public void onTracksChanged(@NotNull EventTime eventTime, @NotNull TrackGroupArray ignored, @NotNull TrackSelectionArray trackSelections) {
