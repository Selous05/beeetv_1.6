    ...
    private  void  onLoadStream(Media media) {
        ...
        if (settingsManager.getSettings().getServerDialogSelection() == 1) {
            ...
            if (media.getVideos().get(0).getEmbed() == 1) {
                        ...
                        if (multipleQuality) {
                            if (vidURL != null) {
                                ...
                                builder.setItems(name, (dialogInterface, wich) -> {
                                    ...
                                    mMediaModel = MediaModel.media(media.getId(), null, currentQuality, type, media.getTitle(), vidURL.get(wich).getUrl(), artwork, null,
                                            null, null, null, null,
                                            null, null, null,
                            ...
                            mMediaModel = MediaModel.media(media.getId(), null, currentQuality, type, media.getTitle(), vidURL.get(0).getUrl(), artwork, null,
                                    null, null, null, null,
                                    null, null, null,
                                    null, media.getPremuim(), hls, null,media.getImdbExternalId()
                                    ,media.getPosterPath(),media.getHasrecap(),media.getSkiprecapStartIn(),mediaGenre,null,media.getVoteAverage());
                ...
                mMediaModel = MediaModel.media(media.getId(), null, currentQuality, type, media.getTitle(), streamLink, artwork, null,
                        null, null, null, null,
                        null, null, null,
                        null, media.getPremuim(), hls, null,media.getImdbExternalId()
                        ,media.getPosterPath(),media.getHasrecap(),media.getSkiprecapStartIn(),mediaGenre,null,media.getVoteAverage());
