...
import com.beeecorptv.databinding.FragmentDownloadListBinding;
...
import com.beeecorptv.ui.downloadmanager.ui.details.DownloadDetailsDialog;
    ...
    implements DownloadListAdapter.ClickListener , Injectable
{
    ...
    private void shareDownloads()
    {
        ...
        disposables.add(Observable.fromIterable(selections)
                .toList()
                .subscribe(items -> {
                    Intent intent = Utils.makeFileShareIntent(requireActivity().getApplicationContext(), items);
                    if (intent != null) {
    ...
    private void shareUrl()
    {
        ...
        disposables.add(Observable.fromIterable(selections)
                ...
                .toList()
                .subscribe(urlList -> startActivity(Intent.createChooser(
