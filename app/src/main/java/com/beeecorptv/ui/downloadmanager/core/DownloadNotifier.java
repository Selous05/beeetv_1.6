...
package com.beeecorptv.ui.downloadmanager.core;

import static android.content.Context.NOTIFICATION_SERVICE;
import static com.beeecorptv.ui.downloadmanager.core.model.data.entity.DownloadInfo.VISIBILITY_HIDDEN;
import static com.beeecorptv.ui.downloadmanager.core.model.data.entity.DownloadInfo.VISIBILITY_VISIBLE;
import static com.beeecorptv.ui.downloadmanager.core.model.data.entity.DownloadInfo.VISIBILITY_VISIBLE_NOTIFY_COMPLETED;
import static com.beeecorptv.ui.downloadmanager.core.model.data.entity.DownloadInfo.VISIBILITY_VISIBLE_NOTIFY_ONLY_COMPLETION;
...
import com.beeecorptv.ui.downloadmanager.core.model.data.entity.InfoAndPieces;
...
import com.beeecorptv.ui.downloadmanager.core.system.SystemFacadeHelper;
import com.beeecorptv.ui.downloadmanager.core.utils.DateUtils;
import com.beeecorptv.ui.downloadmanager.core.utils.Utils;
import com.beeecorptv.ui.downloadmanager.receiver.NotificationReceiver;
...
public class DownloadNotifier
{
    ...
    private void updateWithLocked(InfoAndPieces infoAndPieces, Notification notify, String tag, int type)
    {
        ...
        if (type == TYPE_ACTIVE || type == TYPE_PENDING) {
            ...
            @SuppressLint("UnspecifiedImmutableFlag") PendingIntent pauseResumeButtonPendingIntent =
            ...
            @SuppressLint("UnspecifiedImmutableFlag") PendingIntent stopButtonPendingIntent =
                    PendingIntent.getBroadcast(
                            appContext,
                            0,
                            stopButtonIntent,
            ...
            @SuppressLint("UnspecifiedImmutableFlag") PendingIntent startupPendingIntent =
            ...
            if (!isError) {
                Intent startupIntent = new Intent(appContext, SplashActivity.class);
                startupIntent.setAction(Intent.ACTION_MAIN);
                startupIntent.addCategory(Intent.CATEGORY_LAUNCHER);
                startupIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
            }
