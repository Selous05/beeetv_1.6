...
public class MovieDetailViewModel extends ViewModel {
    ...
    public final MutableLiveData<List<Opensub>> movieSbustMutableLiveData = new MutableLiveData<>();
    ...
    @Inject
    MovieDetailViewModel(MediaRepository mediaRepository, SettingsManager settingsManager) {
    ...
    public void getSubsPageDetails (String movieId) {
        compositeDisposable.add(mediaRepository.getMovieSubs(movieId)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .cache()
                .subscribe(movieSbustMutableLiveData::postValue, this::handleError)
        );
    }
    ...
    public void getMovieExternalId(String id) {
        compositeDisposable.add(mediaRepository.getMovieExternal(id)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .cache()
    ...
    public LiveData<Series> isFavoriteSerie(int movieId) {
        ...
        return mediaRepository.isFavoriteSerie(movieId);
    }
