package com.beeecorptv.ui.streaming;
...
import com.beeecorptv.databinding.ItemStreamDetailBinding;
...
public class StreamingetailsActivity extends AppCompatActivity {
    ...
    private void onInitRewards() {
        ...
        Appodeal.initialize(StreamingetailsActivity.this, settingsManager.getSettings().getAdUnitIdAppodealRewarded(), Appodeal.INTERSTITIAL | Appodeal.BANNER | Appodeal.REWARDED_VIDEO );
    ...
    private void onLoadAppNextBanner() {
        ...
        if (settingsManager.getSettings().getAppnextPlacementid() !=null) {
            ...
            com.appnext.banners.BannerView appNextBanner = new  com.appnext.banners.BannerView(StreamingetailsActivity.this);
    ...
    private void onLoadUnityBanner() {
        ...
        if (settingsManager.getSettings().getUnityadsBanner() == 1) {
            ...
            bottomBanner = new BannerView(StreamingetailsActivity.this, settingsManager.getSettings().getUnityBannerPlacementId(),
        ...
        if (settingsManager.getSettings().getAppodealBanner() == 1) {
            ...
            Appodeal.setBannerCallbacks(new BannerCallbacks() {
                ...
                public void onBannerLoaded(int i, boolean b) {
                    ...
                    binding.appodealBannerView.setVisibility(View.VISIBLE);
    ...
    private void onLoadAppoDealInterStetial() {
        ...
        if (settingsManager.getSettings().getAppodealInterstitial() == 1) {
            ...
            Appodeal.show(StreamingetailsActivity.this, Appodeal.INTERSTITIAL);
                    ...
                    if (movieDetail.getVideos().get(wich).getEmbed() == 1) {
                        ...
                        if (mCastSession !=null && mCastSession.isConnected()) {
                            ...
                            if (settingsManager.getSettings().getVlc() == 1) {
                                ...
                                startStreamFromDialog(movieDetail,movieDetail.getVideos().get(wich).getLink(),movieDetail.getVideos().get(wich),movieDetail.getVideos().get(wich));
                            }
                    ...
                    if (movieDetail.getVideos().get(0).getEmbed() == 1) {
                        ...
                        if (mCastSession !=null && mCastSession.isConnected()) {
                            ...
                            if (settingsManager.getSettings().getVlc() == 1) {
                                ...
                                startStreamFromDialog(movieDetail,movieDetail.getVideos().get(0).getLink(),movieDetail.getVideos().get(0), movieDetail.getVideos().get(0));
                            }
    ...
    private void startStreamFromExternalLaunchersLink(Media movieDetail, String link, int hls) {
        ...
        mxPlayer.setOnClickListener(v12 -> {
            Tools.streamMediaFromMxPlayer(this,link,media,settingsManager);
            dialog.hide();
    ...
    private void startStreamFromExternalLaunchers(Media movieDetail, String link, MediaStream mediaStream) {
        ...
        easyplexPlayer.setOnClickListener(v12 -> {
            startStreamFromDialog(movieDetail, link, mediaStream, mediaStream);
            dialog.hide();
    ...
    private void onLoadMainPlayerStreamYoutube(Media movieDetail,String downloadUrl) {

        String artwork = movieDetail.getPosterPath();
        String name = movieDetail.getName();
        String type = "streaming";
        Intent intent = new Intent(this, EasyPlexMainPlayer.class);
        intent.putExtra(EasyPlexPlayerActivity.EASYPLEX_MEDIA_KEY, MediaModel.media(movieDetail.getId(),null,null,type, name, downloadUrl, artwork, null
                , null, null,null,
                null,null,
                null,
    ...
    private void startStreamFromDialog(Media movieDetail, String link, MediaStream mediaStream, MediaStream stream) {

        if (stream.getHeader() !=null && !stream.getHeader().isEmpty()) {

            settingsManager.getSettings().setHeader(stream.getHeader());
        }


        if (stream.getUseragent() !=null && !stream.getUseragent().isEmpty()) {

            settingsManager.getSettings().setUserAgent(stream.getUseragent());
        }
    ...
    private void onLoadTitle(String title, String id){
        ...
        binding.shareIcon.setOnClickListener(v -> {
            ...
            binding.shareIcon.setOnClickListener(x -> {
    ...
    protected void onDestroy() {
        ...
        binding.bannerContainer.removeAllViewsInLayout();
