...
public class EpisodeDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        latestEpisodes = intent.getParcelableExtra(ARG_MOVIE);
    ...
    private void onLoadStartAppAds(LatestEpisodes media, String type) {
    ...
    private void createAndLoadRewardedAd() {
        ...
        if ("StartApp".equals(defaultRewardedNetworkAds)) {
            ...
            if (settingsManager.getSettings().getStartappId() != null) {
                ...
                startAppAd = new StartAppAd(EpisodeDetailsActivity.this);
            }


        } else if ("Appodeal".equals(defaultRewardedNetworkAds) && settingsManager.getSettings().getAdUnitIdAppodealRewarded() != null) {

            Appodeal.initialize(EpisodeDetailsActivity.this, settingsManager.getSettings().getAdUnitIdAppodealRewarded(), Appodeal.REWARDED_VIDEO);
